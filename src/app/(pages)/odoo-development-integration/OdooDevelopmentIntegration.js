  ...
  const odooServices = [
    {
      ...
      iconComponent: <ShoppingBag className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["E-commerce Setup", "Website Integration", "Payment Gateway"]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      features: ["Custom Modules", "API Integration", "System Customization"]
    },
    {
      id: 4,
      ...
      features: ["Accounting Software", "HR Management", "Inventory Control"]
    },
    {
      id: 5,
      ...
      iconComponent: <Wrench className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["System Maintenance", "Technical Support", "User Training"]
    },
    {
      id: 6,
      ...
      features: ["Business Intelligence", "Data Analytics", "Custom Reports"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
      ...
      <section 
        ...
        style={{
          backgroundImage: "url('/images/3393544.jpg')",
      ...
      >
        ...
        <div className="relative container mx-auto max-w-6xl z-10 px-4 sm:px-6">
          ...
          <div className="inline-flex items-center gap-2 bg-gray-900/80 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full mb-4 sm:mb-6 border border-gray-700">
            ...
            <span className="text-orange-300 text-xs sm:text-sm font-medium">📊 #1 Odoo Development Studio</span>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 mb-6 sm:mb-8 max-w-3xl bg-gray-900/70 backdrop-blur-sm p-3 sm:p-4 md:p-6 rounded-xl border border-gray-800/50">
            We build <span className="text-orange-300 font-bold">comprehensive Odoo solutions</span> that 
      ...
      {/* Services Section - Odoo Development Cards */}
      <section 
        ref={el => sectionRefs.current[1] = el}
        data-index="1"
        className="section-slide py-12 sm:py-16 md:py-20 px-4 md:px-6 bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 relative"
      >
        <div className="container mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-3 sm:mb-4 md:mb-6">
              Odoo Development <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-blue-400">Solutions</span>
            </h2>
            
            <p className="text-gray-300 text-sm sm:text-base md:text-lg max-w-3xl mx-auto mb-4 sm:mb-6 md:mb-8">
              Comprehensive Odoo ERP solutions for business automation and integration
            </p>
            ...
            <div className="bg-gray-900/80 backdrop-blur-sm p-3 sm:p-4 md:p-6 lg:p-8 rounded-xl md:rounded-2xl border border-gray-800/50">
              <p className="text-gray-300 text-sm sm:text-base md:text-lg max-w-4xl mx-auto leading-relaxed">
                ...
                We specialize in crafting high-quality Odoo solutions, ERP systems, and digital integrations that blend creativity 
      ...
      <section 
        ...
        data-index="2"
        className="section-slide py-12 sm:py-16 md:py-20 px-4 md:px-6 bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950"
      >
            ...
            <div>
              <div className="mb-4 sm:mb-6 md:mb-8">
                ...
                <p className="text-gray-300 text-sm sm:text-base md:text-lg mb-4 sm:mb-6 md:mb-8">
                  Fill out the form or reach us via the provided contact number or email to discuss your ideas and get started on your Odoo project with our expert team.
                </p>
              </div>
