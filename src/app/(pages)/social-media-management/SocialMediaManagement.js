...
import { 
  Sparkles, Zap, Users as UsersIcon, Calendar as CalendarIcon,
  MessageCircle, Hash, BarChart, SparkleIcon, Rocket,
  ArrowRight, Target as TargetIcon
} from "lucide-react";
...
const SocialMediaManagement = () => {
  ...
  const socialMediaServices = [
    {
      ...
      iconComponent: <TargetIcon className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Strategy Planning", "Content Calendar", "Platform Analysis"]
    },
    {
      id: 2,
      ...
      iconComponent: <CalendarIcon className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Content Scheduling", "Batch Publishing", "Timeline Management"]
    },
    {
      id: 3,
      ...
      iconComponent: <UsersIcon className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Community Building", "Page Management", "Audience Interaction"]
    },
    {
      id: 4,
      ...
      features: ["Profile Optimization", "Brand Guidelines", "Visual Identity"]
    },
    {
      id: 5,
      ...
      iconComponent: <Hash className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Hashtag Research", "Trend Analysis", "Content Strategy"]
    },
    {
      id: 6,
      ...
      iconComponent: <BarChart className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Performance Analytics", "Monthly Reports", "ROI Tracking"]
    }
  ];
  ...
  return (
    <div className="min-h-screen w-full bg-gray-950">
      ...
      <motion.section 
        ref={heroRef}
        className="relative pt-16 md:pt-20 pb-20 md:pb-32 px-4 md:px-6 min-h-[85vh] md:min-h-[90vh] flex items-center justify-center w-full bg-cover bg-center bg-fixed"
        style={{
          backgroundImage: "url('/images/89119.jpg')",
        }}
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <div className="relative container mx-auto max-w-6xl z-10 px-4 sm:px-6 w-full">
          ...
          >
            ...
            <span className="text-orange-300 text-sm font-medium">📱 #1 Social Media Management</span>
          </motion.div>
          ...
          >
            We build <span className="text-orange-300 font-bold">powerful social media presence</span> that 
            drives engagement, grows communities, and boosts brand visibility worldwide.
          </motion.p>
          ...
          >
            <Button className="group bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-6 py-5 sm:px-8 sm:py-6 text-base sm:text-lg rounded-xl">
              <Rocket className="w-5 h-5 mr-2 group-hover:rotate-12 transition-transform" />
              Start Campaign
              <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
            </Button>
            
            <Button variant="outline" className="border-gray-700 text-gray-300 hover:bg-gray-800/50 px-6 py-5 sm:px-8 sm:py-6 text-base sm:text-lg rounded-xl">
        ...
        <div className="container mx-auto max-w-6xl w-full">
          ...
          >
            ...
            <motion.h2 
              ...
              variants={slideUpVariants}
            >
              Social Media <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-blue-400">Management</span>
            </motion.h2>
            ...
            <motion.p 
              ...
              variants={slideUpVariants}
            >
              Comprehensive social media solutions for brand growth and engagement
            </motion.p>
            ...
            >
              ...
              We specialize in crafting high-quality social media strategies, community management, and digital solutions that blend creativity 
              with cutting-edge technology. Our team of skilled marketers, content creators, and strategists transforms ideas into 
            ...
            <div className="w-full">
              <div className="mb-6 md:mb-8 w-full">
                ...
                <p className="text-gray-300 text-base md:text-lg mb-6 md:mb-8 bg-gray-900/70 backdrop-blur-sm p-4 md:p-6 rounded-xl border border-gray-800/50">
                  Fill out the form or reach us via the provided contact number or email to discuss your ideas and get started on your social media management with our expert team.
                </p>
              </div>
