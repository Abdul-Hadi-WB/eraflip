...
import { 
  ...
  Brush, Film, Type, Camera, Edit3, SparkleIcon
} from "lucide-react";
...
const ContentCreation = () => {
  ...
  // Content Creation Services Data
  const contentServices = [
    {
      ...
      iconComponent: <Brush className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Post Design", "Story Creation", "Brand Identity"]
    },
    {
      id: 2,
      ...
      iconComponent: <Film className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Video Production", "Reels Creation", "Storytelling"]
    },
    {
      id: 3,
      ...
      iconComponent: <Type className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Copywriting", "Caption Creation", "Brand Voice"]
    },
    {
      id: 4,
      ...
      iconComponent: <Camera className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Photography", "Videography", "Product Showcase"]
    },
    {
      id: 5,
      ...
      iconComponent: <Edit3 className="w-6 h-6 md:w-8 md:h-8" />,
      features: ["Blog Writing", "SEO Content", "Content Strategy"]
    }
  ];
  ...
  return (
    <div className="min-h-screen w-full bg-gray-950">
      ...
      <motion.section 
        ...
        style={{
          backgroundImage: "url('/images/flat-lay-workstation-with-copy-space-tablet.jpg')",
      ...
      >
        ...
        <div className="relative container mx-auto max-w-6xl z-10 px-4 sm:px-6 w-full">
          ...
          >
            ...
            <span className="text-orange-300 text-sm font-medium">🎨 #1 Content Creation</span>
          </motion.div>
          ...
          >
            We create <span className="text-orange-300 font-bold">stunning visual content</span> that 
        ...
        <div className="container mx-auto max-w-6xl w-full">
          ...
          >
            ...
            <motion.h2 
              ...
              variants={slideUpVariants}
            >
              Content <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-blue-400">Creation</span>
            </motion.h2>
            ...
            <motion.p 
              ...
              variants={slideUpVariants}
            >
              Professional content creation services for brand storytelling and audience engagement
            </motion.p>
            ...
            >
              ...
              We specialize in crafting high-quality visual content, creative storytelling, and digital solutions that blend creativity 
              with cutting-edge technology. Our team of skilled creators, designers, and strategists transforms ideas into 
          ...
          {/* Services Grid - First 3 Cards */}
          <motion.div 
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12 w-full"
            variants={staggerContainer}
            initial="hidden"
            animate={isServicesInView ? "visible" : "hidden"}
            transition={{ delayChildren: 0.1 }}
          >
            {contentServices.slice(0, 3).map((service, index) => (
              <motion.div 
                key={service.id}
                className="group"
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 max-w-2xl w-full">
              {contentServices.slice(3).map((service, index) => (
                <motion.div 
                  key={service.id}
                  className="group"
                  variants={cardVariants}
            ...
            <div className="w-full">
              <div className="mb-6 md:mb-8 w-full">
                ...
                <p className="text-gray-300 text-base md:text-lg mb-6 md:mb-8 bg-gray-900/70 backdrop-blur-sm p-4 md:p-6 rounded-xl border border-gray-800/50">
                  Fill out the form or reach us via the provided contact number or email to discuss your ideas and get started on your content creation with our expert team.
                </p>
              </div>
